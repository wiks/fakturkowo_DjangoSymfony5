...
--
-- Host: localhost:3306
-- Czas generowania: 26 Kwi 2020, 00:08
...
(5, '44/12', '2020-04-25', '2020-05-25', NULL, '2020-05-25', '', '0.00', '0.00', '0.00', '2020-04-25 21:24:43.861441', 1),
(6, '44/14', '2020-04-25', '2020-05-25', NULL, '2020-05-25', '', '0.00', '0.00', '0.00', '2020-04-25 21:57:57.832425', 1);

-- --------------------------------------------------------

--
-- Struktura tabeli dla tabeli `invoices_invoices0`
--

CREATE TABLE `invoices_invoices0` (
  `id` int(11) NOT NULL,
  `nr` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `dt_created` date DEFAULT NULL,
  `dt_delivery` date DEFAULT NULL,
  `pay_form_id` int(11) DEFAULT NULL,
  `dt_pait_to` date DEFAULT NULL,
...
(1, 'jabłka', '279.50', 1, 4),
(2, 'pomarańcze', '940.90', 2, 1),
(3, 'banany', '873.90', 1, 3),
(4, 'truskawki', '829.60', 1, 3),
(5, 'awokado', '950.00', 2, 2),
(6, 'pomidory', '333.50', 2, 4),
(7, 'ananas', '977.10', 1, 3),
(8, 'grejpfrut', '750.10', 1, 3),
(9, 'cytryny', '744.10', 1, 1),
(10, 'mleko o niskiej zawartości tłuszczu', '327.90', 2, 4),
(11, 'jogurt', '782.20', 2, 3),
(12, 'jajka', '826.80', 2, 4),
(13, 'twarożek', '793.60', 2, 2),
(14, 'ser żółty', '56.90', 1, 3),
(15, 'masło', '691.00', 1, 4),
(16, 'miód', '743.10', 2, 1),
(17, 'pierś z kurczaka', '623.40', 2, 3),
(18, 'szynka z indyka', '362.50', 1, 3),
(19, 'owoce morza', '964.50', 1, 1),
(20, 'łosoś', '645.40', 2, 1),
(21, 'dorsz', '120.20', 1, 2),
(22, 'sól', '964.10', 2, 2),
(23, 'cukier', '149.60', 1, 3),
(24, 'cynamon', '312.50', 1, 4),
(25, 'kolendra', '657.60', 1, 3),
(26, 'oregano', '445.00', 2, 1),
(27, 'czarny pieprz', '119.70', 1, 3),
(28, 'czosnek', '992.60', 1, 2),
(29, 'goździki', '804.70', 1, 2),
(30, 'kminek', '548.80', 2, 1),
(31, 'imbir', '804.70', 1, 4),
(32, 'pietruszka', '789.50', 1, 4),
(33, 'liście bazylii', '517.40', 1, 3),
(34, 'ketchup', '223.80', 1, 2),
(35, 'musztarda', '930.00', 2, 3),
(36, 'cebula', '540.50', 2, 1),
(37, 'ziemniaki', '807.30', 2, 3),
(38, 'brokuły', '261.70', 2, 2),
(39, 'marchew', '720.30', 2, 2),
(40, 'buraki', '118.80', 1, 2),
(41, 'szpinak', '868.60', 2, 1),
(42, 'papryka', '604.20', 2, 2),
(43, 'sałata', '393.80', 2, 1),
(44, 'seler', '70.40', 2, 1),
(45, 'ogórek', '14.50', 2, 3),
(46, 'ciecierzyca', '751.90', 2, 2),
(47, 'fasola', '607.70', 2, 2),
(48, 'soja', '873.30', 1, 1),
(49, 'olej sezamowy', '742.10', 1, 3),
(50, 'olej rzepakowy', '652.10', 1, 3),
(51, 'oliwa z oliwek', '0.40', 2, 1),
(52, 'migdały', '669.60', 2, 1),
(53, 'nasiona lnu', '72.10', 2, 4),
(54, 'orzeszki ziemne', '245.30', 1, 4),
(55, 'orzechy włoskie', '324.70', 2, 1),
(56, 'słonecznik', '931.50', 1, 1),
(57, 'masło orzechowe', '182.20', 1, 3),
(58, 'dżem', '191.70', 1, 1),
(59, 'koncentrat pomidorowy', '303.60', 1, 4),
(60, 'pomidory w puszce', '696.60', 1, 4),
(61, 'tofu', '828.50', 2, 1),
(62, 'pasztet roślinny', '371.40', 2, 3),
(63, 'daktyle', '616.80', 1, 3),
(64, 'rodzynki suszone', '654.30', 2, 2),
(65, 'hummus', '11.10', 1, 3),
(66, 'mąka', '339.40', 1, 3);
...
(1, 'WikS.eu', '[\"ul. Pi\\u0142sudskiego 5/1\", \"72-600 \\u015awinouj\\u015bcie\"]', 'wiks@wiks.eu', '573-214-78-63', '12345678512347', '71050103357', '[\"75 1020 4870 0000 5602 0076 5859\", \"PKO BP\"]', NULL, '2020-04-25 15:48:00.095894');
...
--
-- Indexes for table `invoices_invoices0`
--
ALTER TABLE `invoices_invoices0`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `nr` (`nr`),
  ADD KEY `invoices_invoices0_customer_id_5eacf8b5_fk_myfirm_firmdata_id` (`customer_id`),
  ADD KEY `invoices_invoices0_vat_id_61fef362_fk_items_vats_id` (`vat_id`);
...
--
-- AUTO_INCREMENT dla tabeli `invoices_invoices0`
--
ALTER TABLE `invoices_invoices0`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- Ograniczenia dla tabeli `invoices_invoices0`
--
ALTER TABLE `invoices_invoices0`
  ADD CONSTRAINT `invoices_invoices0_customer_id_5eacf8b5_fk_myfirm_firmdata_id` FOREIGN KEY (`customer_id`) REFERENCES `myfirm_firmdata` (`id`),
  ADD CONSTRAINT `invoices_invoices0_vat_id_61fef362_fk_items_vats_id` FOREIGN KEY (`vat_id`) REFERENCES `items_vats` (`id`);
